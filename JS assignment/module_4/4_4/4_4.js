...
document.querySelector('form').addEventListener(
    ...
    async function(event){
        ...
        try{
            ...
            const supply_img = 'https://www.freecodecamp.org/news/content/images/size/w2000/2021/08/imgTag.png';
            result.innerHTML = '';
            ...
            for (let item of json_data){
                ...
                img.setAttribute('src', supply_img);
                if(item.show.image){
                    img.setAttribute('src',item.show.medium);
                }
